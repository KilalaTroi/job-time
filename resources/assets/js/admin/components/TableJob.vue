        ...
        <tbody>
            <tr v-for="(item, index) in data" :key="index">
                ...
                <td class="text-center d-flex justify-content-center">
                    <button type="button" @click="$emit('get-job', item.id, item.schedule_id)" class="btn btn-xs d-flex btn-primary" data-toggle="modal" data-target="#addTime" data-backdrop="static" data-keyboard="false">
