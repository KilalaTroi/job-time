    ...
    <card>
        <template slot="header">
            <div class="d-flex justify-content-between">
                <h4 class="card-title">{{$ml.with('VueJS').get('txtReportCreate')}}</h4>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div  class="form-group">
                    ...
                    <input v-if="language=='ja'" v-model="titleJA" type="text" class="form-control">
                </div>
            </div>

            <div class="col-sm-3">
                <div class="form-group">
                    <label class="text-uppercase"><strong>{{$ml.with('VueJS').get('txtReportType')}}</strong></label>
