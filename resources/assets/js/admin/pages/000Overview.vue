<template>
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    <chart-card :chart-data="lineChart.data" :chart-options="lineChart.options" :responsive-options="lineChart.responsiveOptions" :chart-id="lineChart.id">
                ...
                <div class="col-md-4">
                    <chart-card :chart-data="pieChart.data" chart-type="Pie" :chart-id="pieChart.id">
                        <template slot="header">
