    ...
    <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <div class="lsub-menu">
            <router-link class="active" to="/settings/departments">{{ $ml.with("VueJS").get("sbDepartments") }}</router-link>
            <router-link class="" to="/settings/teams">{{ $ml.with("VueJS").get("sbTeams") }}</router-link>
            <router-link class="" to="/settings/types">{{ $ml.with("VueJS").get("sbJobTypes") }}</router-link>
          </div>
        </div>
