  ...
  <div class="container">
    ...
    <div class="d-flex">
      <div style="min-width: 180px; position: relative">
        <p>Yours sincerely,</p>
        <span style="width: 180px; line-height: 31px; position: absolute; bottom: -8px; left: 0; {{ isset($contentName) && !empty($contentName) ? 'font-size: 20px' : '' }}" class="d-inline-block overflow-x-hidden">{{ $contentName }}</span>
      </div>
